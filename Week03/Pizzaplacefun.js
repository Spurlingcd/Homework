...
getPizzaOrder('large', 'thick', 'bacon', ' pepperoni', ' extra cheese', ' fresh garlic');
...
const pizza = [size, crust, ...amountOfToppings] ;
let size = 'large';
let crust = 'thick';
let amountOfToppings =  ['bacon', ' pepperoni', ' extra cheese', ' fresh garlic']
function preparePizza(pizza) {
    const objPizza = {
      pizzaSize: pizza[0],
      pizzaCrust: pizza[1],
      pizzaToppings: pizza[2]
    };
